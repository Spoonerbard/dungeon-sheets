...
class Piwafwi(MagicItem):
    """This dark spider-silk cloak is made by drow. It is a cloak of elvenkind.
...
made to hide, as the cloak's color shifts to camouflage you. Pulling the hood up
or down requires an action.
    """
    requires_attunement = True
    name = "piwafwi"
