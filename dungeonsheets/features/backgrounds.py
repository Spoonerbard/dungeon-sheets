...
class BadReputation(Feature):
    ...
    When you are in a civilized settlement, you can get away with minor
    criminal offenses, such as refusing to pay for food at a tavern or
    breaking down doors at a local shop, since most people will not report
    your activity to the authorities.
    """
    name = "Bad Reputation"
    source = "Background (Variant Sailor (Pirate))"
